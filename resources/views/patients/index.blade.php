                ...
                <form action="{{ route('patients.store') }}" method="POST">
                    ...
                    <div id="adultsSection">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="adult_middle_names[]" id="adult_middle_name_0" class="form-control">
                        </div>
                        <div class="form-group">
...
<table class="table">
    ...
    <tr>
        ...
        <td>
            ...
            <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#dischargeModal{{ $patient->id }}">Discharge</button>
            @else
            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#intakeModal{{ $patient->id }}">Intake</button>
            @endif
            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editPatientModal{{ $patient->id }}">Edit</button>
        </td>
    </tr>
    ...
    <!-- Intake Modal -->
    <div class="modal fade" id="intakeModal{{ $patient->id }}" tabindex="-1" role="dialog" aria-labelledby="intakeModalLabel{{ $patient->id }}" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <!-- Discharge Modal -->
    <div class="modal fade" id="dischargeModal{{ $patient->id }}" tabindex="-1" role="dialog" aria-labelledby="dischargeModalLabel{{ $patient->id }}" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="editPatientModal{{ $patient->id }}" tabindex="-1" role="dialog" aria-labelledby="editPatientModalLabel{{ $patient->id }}" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editPatientForm{{ $patient->id }}" action="{{ route('patients.update', $patient) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            <label for="first_name">First Name</label>
                        ...
                        <div id="editKidsSection{{ $patient->id }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="kid_names[]" id="kid_name_{{ $patient->id }}_{{ $index }}" class="form-control" value="{{ $kid->name }}">
                            </div>
                            <div class="form-group">
                                <label for="kid_dob_{{ $patient->id }}_{{ $index }}">Date of Birth</label>
                                <input type="date" name="kid_dobs[]" id="kid_dob_{{ $patient->id }}_{{ $index }}" class="form-control" value="{{ $kid->dob }}">
                            </div>
                            @endforeach
                        </div>
                        <button type="button" class="btn btn-primary" id="addEditKidButton{{ $patient->id }}">Add Kid</button>
                        ...
                        <div id="editAdultsSection{{ $patient->id }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="adult_first_names[]" id="adult_first_name_{{ $patient->id }}_{{ $index }}" class="form-control" value="{{ $adult->first_name }}">
                            </div>
                            <div class="form-group">
                                <input type="hidden" name="adult_ids[]" value="{{ $adult->id }}">
                                <label for="adult_middle_name_{{ $patient->id }}_{{ $index }}">Name</label>
                                <input type="text" name="adult_middle_names[]" id="adult_middle_name_{{ $patient->id }}_{{ $index }}" class="form-control" value="{{ $adult->middle_name }}">
                            </div>
                            <div class="form-group">
                                <input type="hidden" name="adult_ids[]" value="{{ $adult->id }}">
                                <label for="adult_last_name_{{ $patient->id }}_{{ $index }}">Name</label>
                                <input type="text" name="adult_last_names[]" id="adult_last_name_{{ $patient->id }}_{{ $index }}" class="form-control" value="{{ $adult->last_name }}">
                            </div>
                            <div class="form-group">
                                <label for="adult_dob_{{ $patient->id }}_{{ $index }}">Date of Birth</label>
                                <input type="date" name="adult_dobs[]" id="adult_dob_{{ $patient->id }}_{{ $index }}" class="form-control" value="{{ $adult->dob }}">
                            </div>
                            @endforeach
                        </div>
                        <button type="button" class="btn btn-primary" id="addEditAdultButton{{ $patient->id }}">Add Adult</button>
                        <br>
...
<script>
    $(document).ready(function() {
        var editKidCount = {{ $patient->kids_count }};
        var editAdultCount = {{ $patient->adults_count }};
